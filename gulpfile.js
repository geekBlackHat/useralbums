...
gulp.task('inject-scripts',function(){
	...
	var jq = gulp.src(['./app/assets/js/jquery.slim.min.js'], {read:false});
	var popper = gulp.src(['./app/assets/js/popper.min.js'], {read:false});
	var angularLibsStream = gulp.src(['./app/assets/js/*js','!./app/assets/js/angular.min.js','!./app/assets/js/jquery.slim.min.js','!./app/assets/js/popper.min.js'], {read:false});
	...
	.pipe(inject(series(ang, jq , popper ,angularLibsStream, appStream, servicesStream, controllersStream, filtersStream, directivesStream),{relative:true}))
	.pipe(gulp.dest('./app'));
});
